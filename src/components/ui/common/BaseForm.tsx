      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <div className="flex flex-col space-y-4 lg:flex-row lg:items-center lg:justify-between lg:space-y-0">
            <div className="flex items-center space-x-4">
              <Button variant="secondary" onClick={handleBack} className="flex items-center space-x-2 text-sm">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200">
          ...
          {(createdAt || updatedAt || createdBy || updatedBy || isActive !== undefined) && (
            <div className="border-t border-gray-100 bg-gray-50/50 px-6 lg:px-8 py-6">
                ...
                {createdBy && (
                  <div className="space-y-1">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <p className="text-gray-900 font-medium text-xs">{createdBy}</p>
                    </div>
                  </div>
                )}
                {updatedBy && (
                  <div className="space-y-1">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <p className="text-gray-900 font-medium text-xs">{updatedBy}</p>
                    </div>
                  </div>
                )}
              </div>
